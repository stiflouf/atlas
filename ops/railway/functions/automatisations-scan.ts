...
// Appelle POST /api/automatisations/scan sur DOMIORA. Ne journalise jamais JOB_SECRET ni l'en-tête
// Authorization — voir docs/PILOT_RUNBOOK.md (section 5, Jobs périodiques) pour le contrat exact de la route.
const NOM_JOB = "automatisations-scan";
const ENDPOINT = "/api/automatisations/scan";
