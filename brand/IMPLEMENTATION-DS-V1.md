...
| 10 | **Fiche Bien**, une PR par onglet ou unité fonctionnelle de `BienTabs` (§ J.5) — 10A ✅ (§ J.18), 10B ✅ (§ J.19), 10C ✅ (§ J.20), 10D ✅ (§ J.21), 10E ✅ (§ J.22), 10F ✅ (§ J.23), 10G scindé en 10G1 ✅ (§ J.26)/10G2 ✅ (§ J.27)/10G3 à venir | `components/bien/`, `ui/Tabs.tsx`, `components/offre/OffreFormulaire.tsx` |
