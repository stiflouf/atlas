...
function EtatHonnete({ bienId, titre, message }: { bienId?: string; titre: string; message: string }) {
  return (
    <div className="px-4 py-6 md:px-8 md:py-8 max-w-2xl">
      ...
      <h1 className="text-[20px] md:text-[24px] font-semibold text-text-1 leading-tight mb-3">{titre}</h1>
...
export default async function NouveauCompromisPage({ searchParams }: PageProps) {
  ...
  return (
    <div className="px-4 py-6 md:px-8 md:py-8 max-w-2xl">
      ...
      <h1 className="text-[20px] md:text-[24px] font-semibold text-text-1 leading-tight mb-1">Nouveau compromis</h1>
