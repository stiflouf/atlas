...
import { basculerAutomatisationAction } from "@/actions/automatisations";
import { deriverEtatExecutionAutomatisation, type EtatExecutionAutomatisation } from "@/types/automatisation";
  ...
  return (
    <div className="px-4 py-6 md:px-8 md:py-8 max-w-2xl">
      ...
      <div className="flex flex-col gap-3">
        {lignes.map(({ regle, config, derniereExecution }) => {
